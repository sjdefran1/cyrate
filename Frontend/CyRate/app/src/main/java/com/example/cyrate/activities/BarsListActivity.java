...
public class BarsListActivity extends AppCompatActivity implements BusinessRecyclerViewInterface, NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.barsList_recyclerView);
    ...
    private void setUpBusinessListCardModels() throws JSONException {
        ...
        businessServiceLogic.getAllBars(new getBusinessesResponse() {
            @Override
            ...
            public void onError(String s) {
                Log.d("TEST 1", s);
                Toast.makeText(BarsListActivity.this, s, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onBusinessClick(int position) {
        ...
        intent.putExtra("PREVIOUS_ACTIVITY", Const.BARS_ACT);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        if (menuItem.getItemId() != R.id.nav_allBusinesses){
            NavMenuUtils.onNavItemSelected(menuItem, BarsListActivity.this);
        }
        else{
            drawerLayout.closeDrawer(GravityCompat.START);
        }
