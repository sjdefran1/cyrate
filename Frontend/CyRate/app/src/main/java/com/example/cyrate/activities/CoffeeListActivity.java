...
public class CoffeeListActivity extends AppCompatActivity implements BusinessRecyclerViewInterface, NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.coffeeList_recyclerView);
    ...
    private void setUpBusinessListCardModels() throws JSONException {
        ...
        businessServiceLogic.getAllCoffee(new getBusinessesResponse() {
            @Override
            ...
            public void onError(String s) {
                Log.d("TEST 1", s);
                Toast.makeText(CoffeeListActivity.this, s, Toast.LENGTH_LONG).show();
            }
        });
    }
